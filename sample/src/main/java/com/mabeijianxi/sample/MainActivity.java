...
import com.mabeijianxi.jianxiexpression.core.EmojIconActions;
...
//        implements View.OnClickListener, ExpressionGridFragment.ExpressionClickListener,ExpressionGridFragment.ExpressionDeleteClickListener
{
...
//    }
    ...
    private void initView() {
        ...
        emojIcon = new EmojIconActions(this, rl_root, et_send_content, iv_emogi);
        ...
        rl_root.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                Log.e("Keyboard", "onTouch: ");
                emojIcon.closeEmojIcon();
                return false;
            }
        });
        emojIcon.addEmojiconEditTextList(et_send_content);
    }

    @Override
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.e("Keyboard", "dispatchTouchEvent: ");
        View currentFocus = getCurrentFocus();
        if (currentFocus instanceof EditText) {
            Log.e("Keyboard", "EditText: ");
        } else {
            Log.e("Keyboard", "closeEmojIcon: ");
            emojIcon.closeEmojIcon();
        }
        emojIcon.closeEmojIcon();
